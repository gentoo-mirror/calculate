...
src_unpack() {
	...
	epatch "${FILESDIR}/calculate-lib-2.2.29-accelerate_package_configure.patch"
	# fix utf8 in format=patch
	epatch "${FILESDIR}/calculate-lib-2.2.29-fix_utf8_patch.patch"
}
