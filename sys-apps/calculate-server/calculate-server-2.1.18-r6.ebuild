...
DEPEND="=sys-apps/calculate-lib-2.1.12-r1
...
PATCHES=(
		...
		"${FILESDIR}/calculate-server-2.1.18-config_path.patch"
		# disable oauth2 for ejabberd
		"${FILESDIR}/calculate-server-2.1.18-disable_jabber_oauth.patch"
		# fix ejabberd.yml
		"${FILESDIR}/calculate-server-2.1.18-fix_ejabberd_yml.patch"
		# fix rebuild
		"${FILESDIR}/calculate-server-2.1.18-fix_rebuild.patch"
)
