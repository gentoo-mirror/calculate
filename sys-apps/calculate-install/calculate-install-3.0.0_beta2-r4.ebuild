...
src_unpack() {
	...
	epatch "${FILESDIR}/calculate-install-3.0.0_beta2_fix_printerror.patch"
	# fix detect default mbr
	epatch "${FILESDIR}/calculate-install-3.0.0_beta2_fix_detect_mbr.patch"
}
