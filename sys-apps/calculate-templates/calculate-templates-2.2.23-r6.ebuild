...
SRC_URI="ftp://ftp.calculate.ru/pub/calculate/calculate2/${PN}/${P}-r5.tar.bz2"
...
src_unpack() {
	...
	# fix chrome custom frame param
	epatch "${FILESDIR}/calculate-templates-2.2.23-fix_chrome.patch"
}
