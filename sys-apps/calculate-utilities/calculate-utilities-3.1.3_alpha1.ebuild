...
RDEPEND="${RDEPEND}
	...
	=sys-apps/calculate-lib-3.1.3_alpha1
	=sys-apps/calculate-core-3.1.3_alpha1
	=sys-apps/calculate-update-3.1.3_alpha1
	cl_client? ( =sys-apps/calculate-client-3.1.3_alpha1 )
