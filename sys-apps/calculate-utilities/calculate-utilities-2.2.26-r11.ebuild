...
RDEPEND="${RDEPEND}
	...
	=sys-apps/calculate-templates-2.2.26-r6
	=sys-apps/calculate-lib-2.2.26-r1
	=sys-apps/calculate-i18n-2.2.26-r1

	cl_assemble? ( =sys-apps/calculate-assemble-2.2.26-r2 )
	cl_builder? ( =sys-apps/calculate-builder-2.2.26-r1 )
	cl_client? ( =sys-apps/calculate-client-2.2.26-r1 )
	cl_desktop? ( =sys-apps/calculate-desktop-2.2.26 )
	cl_installgui? ( =app-misc/calculate-install-gui-2.2.26 )

	cl_server? ( =sys-apps/calculate-server-2.1.15-r1 )
"
