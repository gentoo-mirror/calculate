...
RDEPEND="${RDEPEND}
	...
	=sys-apps/calculate-lib-2.2.29-r5
	=sys-apps/calculate-i18n-2.2.29

	cl_assemble? ( =sys-apps/calculate-assemble-2.2.29-r9 )
	cl_builder? ( =sys-apps/calculate-builder-2.2.29-r9 )
	cl_client? ( =sys-apps/calculate-client-2.2.29-r1 )
	cl_desktop? ( =sys-apps/calculate-desktop-2.2.29-r2 )
