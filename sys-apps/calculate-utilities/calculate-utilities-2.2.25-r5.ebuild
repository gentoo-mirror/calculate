...
RDEPEND="${RDEPEND}
	...
	=sys-apps/calculate-templates-2.2.25-r3
	=sys-apps/calculate-lib-2.2.25
	=sys-apps/calculate-i18n-2.2.25

	cl_assemble? ( =sys-apps/calculate-assemble-2.2.25-r3 )
	cl_builder? ( =sys-apps/calculate-builder-2.2.25-r1 )
