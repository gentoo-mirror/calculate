...
RDEPEND="${RDEPEND}
	=sys-apps/calculate-install-3.1.0_beta1-r1
	...
	cl_desktop? ( =sys-apps/calculate-desktop-3.1.0_beta1-r3 )
	cl_consolegui? ( =sys-apps/calculate-console-gui-3.1.0_beta1-r2 )
