...
RDEPEND="${RDEPEND}
	=sys-apps/calculate-install-3.1.1_alpha2-r1
	=sys-apps/calculate-i18n-3.1.1_alpha2
	=sys-apps/calculate-lib-3.1.1_alpha2
	=sys-apps/calculate-core-3.1.1_alpha2
	=sys-apps/calculate-update-3.1.1_alpha2
	cl_client? ( =sys-apps/calculate-client-3.1.1_alpha2 )
	cl_desktop? ( =sys-apps/calculate-desktop-3.1.1_alpha2 )
