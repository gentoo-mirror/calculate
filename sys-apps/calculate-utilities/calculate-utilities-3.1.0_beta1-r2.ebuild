...
RDEPEND="${RDEPEND}
	...
	=sys-apps/calculate-i18n-3.1.0_beta1
	=sys-apps/calculate-lib-3.1.0_beta1-r2
	=sys-apps/calculate-core-3.1.0_beta1
	cl_client? ( =sys-apps/calculate-client-3.1.0_beta1 )
	cl_desktop? ( =sys-apps/calculate-desktop-3.1.0_beta1 )
