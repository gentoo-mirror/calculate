...
RDEPEND="${RDEPEND}
	=sys-apps/calculate-install-3.1.1_alpha1
	=sys-apps/calculate-i18n-3.1.1_alpha1
	=sys-apps/calculate-lib-3.1.1_alpha1-r1
	=sys-apps/calculate-core-3.1.1_alpha1
	cl_client? ( =sys-apps/calculate-client-3.1.1_alpha1 )
	cl_desktop? ( =sys-apps/calculate-desktop-3.1.1_alpha1 )
	cl_consolegui? ( =sys-apps/calculate-console-gui-3.1.1_alpha1 )
