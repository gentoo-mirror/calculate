...
SRC_URI="ftp://ftp.calculate-linux.org/calculate/source/squidguard-digincore/${P}.tar.bz2
	http://mirror.yandex.ru/calculate/source/squidguard-digincore/${P}.tar.bz2"
