...
SRC_URI="silent? ( 
		ftp://ftp.calculate-linux.org/calculate/themes/calculate/splash-silent-18-r1.png -> ${PN}-silent-18-r1.png
		http://mirror.yandex.ru/calculate/themes/calculate/splash-silent-18-r1.png -> ${PN}-silent-18-r1.png )
	verbose? (
...
src_install() {
	...
	if use silent
	then
		newins "${DISTDIR}"/${PN}-silent-18-r1.png splash-silent.png
	fi
