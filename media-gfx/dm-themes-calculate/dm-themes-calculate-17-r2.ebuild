...
SRC_URI="login? ( ftp://ftp.calculate-linux.org/calculate/themes/calculate/dm-login-${PV}.jpg -> ${PN}-login-${PV}.jpg
	http://mirror.yandex.ru/calculate/themes/calculate/dm-login-${PV}.jpg -> ${PN}-login-${PV}.jpg )
	splash? ( ftp://ftp.calculate-linux.org/calculate/themes/calculate/dm-splash-${PV}.jpg -> ${PN}-splash-${PV}.jpg
