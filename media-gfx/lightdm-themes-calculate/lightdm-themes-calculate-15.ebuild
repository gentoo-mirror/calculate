...
SRC_URI="ftp://ftp.calculate-linux.org/calculate/themes/lightdm/lightdm-calculate-${PV}.tar.bz2
	http://mirror.yandex.ru/calculate/themes/lightdm/lightdm-calculate-${PV}.tar.bz2"
