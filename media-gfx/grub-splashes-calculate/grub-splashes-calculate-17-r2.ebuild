...
SRC_URI="ftp://ftp.calculate-linux.org/calculate/themes/calculate/grub-17-r1.png -> ${P}-r2.png
	http://mirror.yandex.ru/calculate/themes/calculate/grub-17-r1.png -> ${P}-r2.png"
