...
TCP_PROXY_MODULE_URI="https://github.com/yaoweibin/nginx_tcp_proxy_module/zipball/v${TCP_PROXY_MODULE_PV}/$TCP_PROXY_MODULE_P}.zip"
...
CDEPEND="
	...
	nginx_modules_http_passenger? (
		...
		=www-apache/${HTTP_PASSENGER_MODULE_P}
...
src_configure() {
	...
	# third-party modules
	if use nginx_modules_tcp_proxy; then
		myconf+=" --add-module=${ALLWORKDIR}/yaoweibin-nginx_tcp_proxy_module-c541a38"
	fi
