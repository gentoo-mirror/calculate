...
SRC_URI="ftp://ftp.calculate.ru/pub/calculate/themes/icon/icon-calculate-14-r1.tar.bz2
	http://mirror.yandex.ru/calculate/themes/icon/icon-calculate-14-r1.tar.bz2"
