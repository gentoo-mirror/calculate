...
SRC_URI="ftp://ftp.calculate.ru/pub/calculate/themes/icon/icon-calculate-15-r3.tar.bz2
	http://mirror.yandex.ru/calculate/themes/icon/icon-calculate-15-r3.tar.bz2"
