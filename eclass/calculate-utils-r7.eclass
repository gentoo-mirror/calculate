...
# @ECLASS: calculate-utils-r7.eclass
# @MAINTAINER:
...
# @FUNCTION: calculate-utils-r7_src_compile
# @DESCRIPTION:
# Compile all modules of calculate utils
calculate-utils-r7_src_compile() {
	if ! use backup
	then
...
# @FUNCTION: calculate-utils-r7_src_install
# @DESCRIPTION:
# Install all modules of calculate utils
calculate-utils-r7_src_install() {
	prepare_module_info
	for MODULE in "${MODULE_INFO[@]}"
	do
		MODULE_DATA=( $MODULE )
...
calculate-utils-r7_pkg_preinst() {
